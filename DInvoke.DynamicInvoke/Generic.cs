...
namespace DInvoke.DynamicInvoke
{
    ...
    public static class Generic
    {
        ...
        {
            var uModuleName = new Data.DataNative.UNICODE_STRING();
            ...
            if (callResult != Data.DataNative.NTSTATUS.Success || hModule == IntPtr.Zero)
                return IntPtr.Zero;
        ...
        public static IntPtr GetPebLdrModuleEntry(string dllName)
        {
            ...
            var le = (Data.DataNative.LIST_ENTRY)Marshal.PtrToStructure(pInLoadOrderModuleList, typeof(Data.DataNative.LIST_ENTRY));

            // Loop entries
            var flink = le.Flink;
            var hModule = IntPtr.Zero;
            var dte = (Data.DataPE.LDR_DATA_TABLE_ENTRY)Marshal.PtrToStructure(flink, typeof(Data.DataPE.LDR_DATA_TABLE_ENTRY));
            while (dte.InLoadOrderLinks.Flink != le.Blink)
            {
                ...
                dte = (Data.DataPE.LDR_DATA_TABLE_ENTRY)Marshal.PtrToStructure(flink, typeof(Data.DataPE.LDR_DATA_TABLE_ENTRY));
            }
        ...
        {
            var aFunc = new Data.DataNative.ANSI_STRING
            {
        ...
        public static Data.DataPE.PE_META_DATA GetPeMetaData(IntPtr pModule)
        {
            var peMetaData = new Data.DataPE.PE_META_DATA();
            ...
            try
            {
                ...
                peMetaData.ImageFileHeader = (Data.DataPE.IMAGE_FILE_HEADER)Marshal.PtrToStructure((IntPtr)((ulong)pModule + e_lfanew + 0x4), typeof(Data.DataPE.IMAGE_FILE_HEADER));
                ...
                switch (peArch)
                {
                    case 0x010b:
                        ...
                        peMetaData.OptHeader32 =
                            (Data.DataPE.IMAGE_OPTIONAL_HEADER32)Marshal.PtrToStructure(optHeader,
                                typeof(Data.DataPE.IMAGE_OPTIONAL_HEADER32));
                        break;

                    case 0x020b:
                        peMetaData.Is32Bit = false;
                        peMetaData.OptHeader64 =
                            (Data.DataPE.IMAGE_OPTIONAL_HEADER64)Marshal.PtrToStructure(optHeader,
                                typeof(Data.DataPE.IMAGE_OPTIONAL_HEADER64));
                        break;
                ...
                var sectionArray = new Data.DataPE.IMAGE_SECTION_HEADER[peMetaData.ImageFileHeader.NumberOfSections];
                ...
                for (var i = 0; i < peMetaData.ImageFileHeader.NumberOfSections; i++)
                {
                    ...
                    sectionArray[i] = (Data.DataPE.IMAGE_SECTION_HEADER)Marshal.PtrToStructure(sectionPtr, typeof(Data.DataPE.IMAGE_SECTION_HEADER));
                }
        ...
        public static Dictionary<string, string> GetApiSetMapping()
        {
            ...
            var apiSetNamespace = (Data.DataPE.ApiSetNamespace)Marshal.PtrToStructure(pApiSetNamespace, typeof(Data.DataPE.ApiSetNamespace));
            
            for (var i = 0; i < apiSetNamespace.Count; i++)
            {
                var setEntry = new Data.DataPE.ApiSetNamespaceEntry();

                var pSetEntry = (IntPtr)((ulong)pApiSetNamespace + (ulong)apiSetNamespace.EntryOffset + (ulong)(i * Marshal.SizeOf(setEntry)));
                setEntry = (Data.DataPE.ApiSetNamespaceEntry)Marshal.PtrToStructure(pSetEntry, typeof(Data.DataPE.ApiSetNamespaceEntry));
                ...
                var valueEntry = new Data.DataPE.ApiSetValueEntry();
                ...
                valueEntry = (Data.DataPE.ApiSetValueEntry)Marshal.PtrToStructure(pSetValue, typeof(Data.DataPE.ApiSetValueEntry));
        ...
        public static void CallMappedPEModule(Data.DataPE.PE_META_DATA peInfo, IntPtr moduleMemoryBase)
        {
            ...
            Native.NtCreateThreadEx(
                ref hRemoteThread,
                Data.DataWin32.WinNT.ACCESS_MASK.STANDARD_RIGHTS_ALL,
        ...
        /// <param name="moduleMemoryBase">Base address of the module in memory.</param>
        /// <returns>void</returns>
        public static void CallMappedDLLModule(Data.DataPE.PE_META_DATA peInfo, IntPtr moduleMemoryBase)
        {
            ...
            var fDllMain = (Data.DataPE.DllMain)Marshal.GetDelegateForFunctionPointer(lpEntryPoint, typeof(Data.DataPE.DllMain));
            
            try
            {
                var result = fDllMain(moduleMemoryBase, Data.DataPE.DLL_PROCESS_ATTACH, IntPtr.Zero);
        ...
        /// <returns>void</returns>
        public static object CallMappedDLLModuleExport(Data.DataPE.PE_META_DATA peInfo, IntPtr moduleMemoryBase, string exportName, Type functionDelegateType, object[] parameters, bool callEntry = true)
        {
            if (callEntry)
        ...
        /// <param name="callEntry">Specify whether to invoke the module's entry point.</param>
        /// <returns>void</returns>
        public static object CallMappedDLLModuleExport(Data.DataPE.PE_META_DATA peInfo, IntPtr moduleMemoryBase, short ordinal, Type functionDelegateType, object[] parameters, bool callEntry = true)
        {
            if (callEntry)
                CallMappedDLLModule(peInfo, moduleMemoryBase);
        ...
        /// <param name="callEntry">Specify whether to invoke the module's entry point.</param>
        /// <returns>void</returns>
        public static object CallMappedDLLModuleExport(Data.DataPE.PE_META_DATA peInfo, IntPtr moduleMemoryBase, string functionHash, long key, Type functionDelegateType, object[] parameters, bool callEntry = true)
        {
            if (callEntry)
                CallMappedDLLModule(peInfo, moduleMemoryBase);
